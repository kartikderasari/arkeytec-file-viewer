    ...
    <div>
      <md-dialog :md-active.sync="showSettings">
        ...
        <md-list class='md-inset'>
          <md-subheader>Global settings for the Arkeytec Viewer</md-subheader>
          <md-list-item>
        ...
        <div class="md-toolbar-row">
          ...
          <div class="md-toolbar-section-end">
            ...
            <md-button class='md-icon-button' @click='showSettings =! showSettings'>
              ...
              <md-tooltip v-if="!isIOS" md-direction="top">Global settings for the Arkeytec viewer</md-tooltip>
            </md-button>
            <a href="https://arkeytec.com/">
              <img src='src\img\logo_new.png' width="100"/>
              <md-tooltip v-if="!isIOS" md-direction="left">Arkeytec</md-tooltip>
            </a>
          </div>
        </div>
      </md-app-toolbar>
